...
- Join the #events channel on Slack
...
# Notes: Context {.unnumbered .smaller}
...
Solutions are in exercises for previous activity.
...
## Local Regression or Locally Estimated Scatterplot Smoothing (LOESS) {.unnumbered .smaller}
...
6. **Pros & cons (there's a similar question on HW 4)**    
...
7. **Lingo (there's a similar question on HW 4)**        
