...
- Prepare to take notes: 
  - Locate the Quarto Document (QMD) for today's activity 
  - This is where you'll take notes! Use this however is best for your own learning --- you won't hand it in.
  - Download and open the QMD in RStudio:
    - If your computer opens the file in a web browser, you can (1) open a new QMD in RStudio and (2) copy-paste the contents from the web browser into your QMD
...
"Regression: Model Evaluation (Unit 1)" in the course website.

# Notes: R Code {-}

## Intro to tidymodels {-}

We are going to use the **tidymodels** package in R.
...
At first, it will seem like *a lot more code* (and perhaps even *unnecessary*).
...
## Useful Model Evaluation Functions {.unnumbered}
