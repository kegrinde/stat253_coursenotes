...
1. **Design your own algorithm (15 minutes)**       
    ...
    - Document your algorithm in words (not code) in this [google doc](https://docs.google.com/document/d/1nSqysACxHmSDNkLpoOy69nqLQnM5AbSBKiCHQ0qAiNQ/edit?usp=sharing).
    - Your algorithm must:
...
c. wrist is kicked out early! the 1-predictor model produced by this algorithm isn't necessarily the *best* 1-predictor model (same for any number of predictors).
...
b. I think models with 1 and 4 predictors are reasonable.
